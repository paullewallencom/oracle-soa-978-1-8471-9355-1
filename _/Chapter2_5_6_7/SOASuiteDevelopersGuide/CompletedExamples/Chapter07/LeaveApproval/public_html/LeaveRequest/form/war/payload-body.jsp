...
<%@ page import="javax.servlet.http.HttpServletRequest,                  oracle.bpel.services.workflow.task.model.Task"%>
<%@ page import="oracle.bpel.services.workflow.worklist.servlet.Constants"%>
<%@ page import="oracle.bpel.services.workflow.worklist.api.payload.FormUtil,                  oracle.bpel.services.workflow.worklist.api.payload.Field"%>
<%@ page import="oracle.bpel.services.workflow.worklist.api.payload.PayloadFormGenerator,                   oracle.bpel.services.workflow.worklist.api.payload.Form,                   oracle.bpel.services.workflow.worklist.api.payload.PayloadConstant,                   oracle.bpel.services.workflow.client.IWorkflowServiceClient,                   oracle.bpel.services.workflow.client.WorkflowServiceClientFactory,                   oracle.bpel.services.workflow.query.ITaskQueryService,                   oracle.bpel.services.workflow.verification.IWorkflowContext,                   oracle.bpel.services.workflow.worklist.display.*"%>
      ...
      <%
          ...
          String thisDisabled = "";
				...
				<tr><td colspan="3" class="payloadSectionTitle" id="ns1_cl_leaveRequest">Leave Request</td></tr>
					...
					<%
					%>
						<%=getField(payload, form, context, thisDisabled, locale, task, "Employee Id", "/ns0:task/ns0:payload/ns1:leaveRequest/ns1:employeeId", "string")%>
<%
%>
					<%
					%>
						<%=getField(payload, form, context, thisDisabled, locale, task, "Full Name", "/ns0:task/ns0:payload/ns1:leaveRequest/ns1:fullName", "string")%>
<%
%>
					<%
					%>
						<%=getField(payload, form, context, thisDisabled, locale, task, "Start Date", "/ns0:task/ns0:payload/ns1:leaveRequest/ns1:startDate", "date")%>
<%
%>
					<%
					%>
						<%=getField(payload, form, context, thisDisabled, locale, task, "End Date", "/ns0:task/ns0:payload/ns1:leaveRequest/ns1:endDate", "date")%>
<%
%>
					<%
					%>
						<%=getField(payload, form, context, thisDisabled, locale, task, "Leave Type", "/ns0:task/ns0:payload/ns1:leaveRequest/ns1:leaveType", "string")%>
<%
%>
					<%
					%>
						<%=getField(payload, form, context, thisDisabled, locale, task, "Leave Reason", "/ns0:task/ns0:payload/ns1:leaveRequest/ns1:leaveReason", "string")%>
<%
%>
					<%
					%>
						<%=getField(payload, form, context, thisDisabled, locale, task, "Request Status", "/ns0:task/ns0:payload/ns1:leaveRequest/ns1:requestStatus", "string")%>
<%
%>
					<%
